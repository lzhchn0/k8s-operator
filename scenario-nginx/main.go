...
import (
	...
	"blabla.com/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "3de45c04.opencanon.io",
	...
	var t0 = mgr.GetEventRecorderFor("monitoring")
	if t0 == nil {
		setupLog.Error(err, "BAD==unable to start manager")
	} else {
